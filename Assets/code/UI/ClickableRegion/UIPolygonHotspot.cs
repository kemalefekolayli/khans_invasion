...
public class UIPolygonHotspot : MonoBehaviour, IPointerClickHandler, ICanvasRaycastFilter
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"Clicked region: {regionId}, currentProvince: {(currentProvince != null ? currentProvince.provinceName : "NULL")}");
    ...
    private void TryBuild(string buildingType)
    {
        ...
        {
            GameLog.Warning(GameLogCategory.Core, "[UIPolygonHotspot] No province selected!");
            return;
        }
        ...
        if (playerNation == null)
        {
            ...
            if (playerNation == null)
            {
                GameLog.Warning(GameLogCategory.Core, "[UIPolygonHotspot] PlayerNation not found!");
                return;
            }
        }
        ...
        if (builder == null)
        {
            ...
            if (builder == null)
            {
                GameLog.Warning(GameLogCategory.Core, "[UIPolygonHotspot] Builder not found!");
                return;
            }
        }
        ...
        if (cost > 0)
        {
            ...
            GameLog.Log(GameLogCategory.Core, $"[UIPolygonHotspot] Built {buildingType} in {currentProvince.provinceName}");
        }
    }
