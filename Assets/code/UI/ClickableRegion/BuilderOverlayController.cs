...
public class BuilderOverlayController : MonoBehaviour 
{
    ...
    private void OnCityCenterExit(CityCenter cityCenter)
    {
        if (currentProvince != null)
        {
            currentProvince = null;
            HideAllOverlays();
            GameLog.Log(GameLogCategory.Core, "[BuilderOverlay] CityExit -> firing ProvincePanelClosed");
    ...
    private void UpdateOverlays()
    {
        ...
        {
            GameLog.Log(GameLogCategory.Core, $"[BuilderOverlay] Activating overlay for: {building}");
