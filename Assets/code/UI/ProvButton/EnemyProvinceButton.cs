...
public class EnemyProvinceButtons : MonoBehaviour
{
    ...
    private void ShowButtons(ProvinceModel province)
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Showing Raid/Siege for {province.provinceName}");
    }
    ...
    private void UpdateRaidButtonState()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Raid button for {currentProvince.provinceName}: canRaid={canRaid}, loot={currentProvince.availableLoot}");
    }
    ...
    private void UpdateSiegeButtonState()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Siege button for {currentProvince.provinceName}: canSiege={canSiege}, defense={defenseStrength:F0}");
    }
    ...
    private void OnCityCenterExit(CityCenter cityCenter)
    {
        ...
        if (currentProvince != null)
        {
            GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Horse left city center, closing buttons");
            HideButtons();
    ...
    private void OnRaidClicked()
    {
        if (currentProvince == null)
        {
            GameLog.Warning(GameLogCategory.Core, "[EnemyButtons] No province selected for raid!");
            return;
        }
        
        GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] RAID clicked on {currentProvince.provinceName}");
    ...
    private void ExecuteRaid()
    {
        ...
        {
            GameLog.Error(GameLogCategory.Core, "[EnemyButtons] RaidManager not found!");
            return;
        }
        ...
        if (raider == null)
        {
            GameLog.Warning(GameLogCategory.Core, "[EnemyButtons] No raider found!");
            return;
        }
        
        if (!raider.HasArmy)
        {
            GameLog.Warning(GameLogCategory.Core, "[EnemyButtons] Raider has no army!");
            return;
        }
        ...
        {
            GameLog.Warning(GameLogCategory.Core, $"[EnemyButtons] Cannot raid {currentProvince.provinceName} (already raided or no loot)");
            return;
        }
        ...
        if (lootGained > 0)
        {
            GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Raid successful! {raider.GeneralName} gained {lootGained:F0} loot from {currentProvince.provinceName}");
        }
        else
        {
            GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Raid failed - no loot gained");
        }
    }
    ...
    private void OnSiegeClicked()
    {
        if (currentProvince == null)
        {
            GameLog.Warning(GameLogCategory.Core, "[EnemyButtons] No province selected for siege!");
            return;
        }
        
        GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] SIEGE clicked on {currentProvince.provinceName}");
    ...
    private void ExecuteSiege()
    {
        ...
        {
            GameLog.Error(GameLogCategory.Core, "[EnemyButtons] SiegeManager not found!");
            return;
        }
        ...
        if (attacker == null)
        {
            GameLog.Warning(GameLogCategory.Core, "[EnemyButtons] No attacker found!");
            return;
        }
        
        if (!attacker.HasArmy)
        {
            GameLog.Warning(GameLogCategory.Core, "[EnemyButtons] Attacker has no army!");
            return;
        }
        ...
        {
            GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Siege successful! {currentProvince.provinceName} will be conquered next turn.");
        }
        else
        {
            GameLog.Log(GameLogCategory.Core, $"[EnemyButtons] Siege failed: {result}");
        }
    }
}
