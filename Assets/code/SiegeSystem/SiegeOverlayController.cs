...
public class SiegeOverlayController : MonoBehaviour
{
    ...
    private void OnSiegeCancelled(ProvinceModel cancelledProvince)
    {
        ...
        {
            HideSiegeOverlay();
            GameLog.Log(GameLogCategory.Core, $"[SiegeOverlay] Siege cancelled - hiding overlay on {province?.provinceName}");
        }
    }
    ...
    public void ShowSiegeOverlay()
    {
        ...
        {
            GameLog.Warning(GameLogCategory.Core, $"[SiegeOverlay] No sprite renderer found on {province?.provinceName}");
            return;
        }
        ...
        GameLog.Log(GameLogCategory.Core, $"[SiegeOverlay] Showing siege overlay on {province?.provinceName}");
    }
    ...
    public void HideSiegeOverlay()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[SiegeOverlay] Hiding siege overlay on {province?.provinceName}");
    }
