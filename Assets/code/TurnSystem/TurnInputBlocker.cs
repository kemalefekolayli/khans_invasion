...
public class TurnInputBlocker : MonoBehaviour
{
    ...
    private void BlockInput()
    {
        if (logStateChanges)
        {
            GameLog.Log(GameLogCategory.Core, $"[TurnInputBlocker] Blocking input on: {gameObject.name}");
        }
    ...
    private void UnblockInput()
    {
        if (logStateChanges)
        {
            GameLog.Log(GameLogCategory.Core, $"[TurnInputBlocker] Unblocking input on: {gameObject.name}");
        }
