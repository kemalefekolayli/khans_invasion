...
public class EndTurnButton : MonoBehaviour
{
    ...
    private void OnEndTurnClicked()
    {
        ...
        {
            GameLog.Error(GameLogCategory.Core, "[EndTurnButton] TurnManager not found!");
            return;
        }
        
        if (!TurnManager.Instance.CanPlayerTakeAction())
        {
            GameLog.Warning(GameLogCategory.Core, "[EndTurnButton] Cannot end turn - not player's turn!");
            return;
        }
