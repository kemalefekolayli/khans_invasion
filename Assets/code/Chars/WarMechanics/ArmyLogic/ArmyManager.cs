...
public class ArmyManager : MonoBehaviour
{
    ...
    public void RegisterArmy(Army army)
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[ArmyManager] Registered army. Total: {allArmies.Count}");
    }
    ...
    public void UnregisterArmy(Army army)
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[ArmyManager] Unregistered army. Remaining: {allArmies.Count}");
    }
