...
public class ArmyVisuals : MonoBehaviour
{
    ...
    public void RandomizeColor()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[ArmyVisuals] Randomized color to {randomColor}");
    }
    ...
    public void SetColor(TroopColorVariant color)
    {
        ...
        {
            GameLog.Warning(GameLogCategory.Core, "[ArmyVisuals] No TroopLevel component - color not synced");
        }
    }
