...
public class ProvinceAssignmentEditor : EditorWindow
{
    ...
    void RefreshData()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"RefreshData found {allProvinces.Count} provinces");
    ...
    void AssignProvinceToNation(ProvinceModel province, int nationId)
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"✓ Assigned Province_{province.provinceId} to {nation.nationName} (ID:{nationId})");
    }
    ...
    void SaveAssignments()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"✓ Saved {assignments.Count} province assignments to {path}");
    ...
    void LoadAssignments()
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"✓ Loaded {loadedCount} province assignments");
