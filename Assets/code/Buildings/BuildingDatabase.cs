...
public class BuildingDatabase : ScriptableObject
{
    ...
    public BuildingData GetBuilding(string buildingName)
    {
        ...
        GameLog.Warning(GameLogCategory.Core, $"[BuildingDatabase] Building '{buildingName}' not found!");
        return null;
    }
    ...
    public void ApplyBuildingBenefits(ProvinceModel province, string buildingName)
    {
        ...
        GameLog.Log(GameLogCategory.Core, $"[BuildingDatabase] Applied {buildingName} benefits to {province.provinceName}");
    }
}
